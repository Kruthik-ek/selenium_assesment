...
public class Day6_assesment_tc1 {
	...
	public static void main(String[] args) throws EncryptedDocumentException, IOException, InterruptedException, AWTException {
		...
		FileInputStream fis = new FileInputStream("src/test/resources/task2.properties");
		...
		//excel
		FileInputStream fis2 = new FileInputStream("src/test/resources/DDT/Day6W.xlsx");
...
//		driver.findElement(By.xpath("")).click();
		...
		if(driver.findElement(By.xpath("//div[@class=\"oxd-table-cell oxd-padding-cell\"]/child::div[contains(.,\"Kruthik777\")]")).isDisplayed()) {
